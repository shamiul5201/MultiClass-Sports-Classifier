...
### Imported Libraries and Set Seeds
...
I wrote a function to load and preprocess the dataset using TensorFlow's **image_dataset_from_directory** utility. Key steps included:
...
- **Data Augmentation Integration**: When data augmentation was enabled, I applied the augmentation pipeline only to the training dataset, leaving the validation set unaltered to maintain evaluation consistency.
...
### Generating Test Set Predictions and Saving to CSV
